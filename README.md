...
- 知人にアプリを実際に触ってもらい、フィードバックをもらうようにしました。各機能の使い方が分かりにくいという意見から【？】ボタンをつけて、各機能の説明を表示しました。

# 🔧 課題や今後実装したい機能
- モデル・ビュー・コントローラーの可読性の向上させる。データベースとのやり取りはモデルに記載する。またヘルパーファイルやサービスクラスを活用する。
